  ...
  return (
    <Transition appear show={isOpen} as={Fragment}>
      <Dialog
        ...
        onClose={closeModal}
      >
        <div className="min-h-screen px-4 text-center incslip">
          <Transition.Child
            as={Fragment}
          ...
          >
            <div className="my-8 inline-block w-full max-w-md transform overflow-hidden rounded-lg bg-white text-left align-middle shadow-xl transition-all">
              ...
              <div className="mt-4 flex space-x-2 px-4 pb-6">
                <button
                  className="flex w-full items-center incbutton justify-center space-x-1 rounded-md border border-blue-500 py-2 text-sm text-blue-500 shadow-sm hover:bg-blue-500 hover:text-white"
